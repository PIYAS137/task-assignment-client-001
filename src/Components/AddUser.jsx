        ...
        <div>
            ...
            <div className={`${modalStatus ? "block" : "hidden"} absolute left-0 top-0 w-full bg-[#000000cf] h-full z-50 flex justify-center items-center`}>
                <form className="w-[500px]" method="dialog">
                    ...
                    <input onChange={e => setName(e.target.value)} name="name" required type="text" placeholder="Enter Name" className="input input-bordered w-full " />
                    <label className="block text-sm font-bold mt-2">Email</label>
                    <input onChange={e => setEmail(e.target.value)} required name="email" type="email" placeholder="Enter Email" className="input input-bordered w-full " />
                    <label className="block text-sm font-bold mt-2">Phone</label>
                    <input onChange={e => setPhone(e.target.value)} required name="number" type="number" placeholder="Enter Phone" className="input input-bordered w-full " />
